...
exports.SurgeriesAdmissionsAndConsultsReportSector = void 0;
const PrismaInstance_1 = require("../../interface/PrismaInstance");
function SurgeriesAdmissionsAndConsultsReportSector(initialDate, finalDate) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const proceduresByConsults = consult.flatMap((consults) => {
            return consults.consultDebits.filter((c) => c.sectorId === 4);
        });
        const proceduresByAdmissions = admission.flatMap((admission) => {
            return admission.consultDebits.filter((a) => a.sectorId === 4);
        });
...
exports.SurgeriesAdmissionsAndConsultsReportSector = SurgeriesAdmissionsAndConsultsReportSector;
