...
exports.LabsImageAdmissionsAndConsultsReportSector = void 0;
const PrismaInstance_1 = require("../../interface/PrismaInstance");
function LabsImageAdmissionsAndConsultsReportSector(initialDate, finalDate) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const proceduresByConsults = consult.flatMap((consults) => {
            return consults.consultDebits.filter((c) => c.sectorId === 3);
        });
        const proceduresByAdmissions = admission.flatMap((admission) => {
            return admission.consultDebits.filter((a) => a.sectorId === 3);
        });
...
exports.LabsImageAdmissionsAndConsultsReportSector = LabsImageAdmissionsAndConsultsReportSector;
