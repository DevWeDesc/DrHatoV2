...
exports.OutpatientAdmissionsAndConsultsReportSector = void 0;
const PrismaInstance_1 = require("../../interface/PrismaInstance");
function OutpatientAdmissionsAndConsultsReportSector(initialDate, finalDate) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const proceduresByAdmissions = admission.flatMap((admission) => {
            return admission.consultDebits.filter((a) => a.sectorId === 1);
        });
...
exports.OutpatientAdmissionsAndConsultsReportSector = OutpatientAdmissionsAndConsultsReportSector;
