...
exports.AnesthesiaAdmissionsAndConsultsReportSector = void 0;
const PrismaInstance_1 = require("../../interface/PrismaInstance");
function AnesthesiaAdmissionsAndConsultsReportSector(initialDate, finalDate) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const proceduresByConsults = consult.flatMap((consults) => {
            return consults.consultDebits.filter((c) => c.sectorId === 8);
        });
...
exports.AnesthesiaAdmissionsAndConsultsReportSector = AnesthesiaAdmissionsAndConsultsReportSector;
