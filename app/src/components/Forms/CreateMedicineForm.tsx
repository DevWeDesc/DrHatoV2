...
export function CreateMedicineForm() {
  ...
  const handleCreateNewMedicine: SubmitHandler<CreateNewPetProps>  = async (values) => {
   console.log(values)
  }
   return (
    <ChakraProvider>
      ...
      <Textarea  maxWidth={320} {...register("plant")}bgColor="green.50" placeholder='Digite a Substância aqui' />

      </VStack>
     
      <FormLabel htmlFor="plant">Apresentação</FormLabel>
      <Input {...register("plant")} id="plant" type="text"  maxWidth={320}name="plant"  />

      <VStack>
      <Text>Posologia</Text>
      <Textarea maxWidth={320} {...register("plant")}bgColor="green.50" placeholder='Digite a posologia aqui' />
      </VStack>
      ...
      <Button maxWidth={320} mt="14" colorScheme="whatsapp" type="submit">Cadastrar</Button>
