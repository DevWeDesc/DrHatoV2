    ...
    <ChakraProvider>
      <WorkSpaceContainer>
        ...
        <Flex justify="space-between" align="center" width="100%" height="100%">
          ...
          <Text m="2" fontSize="2xl" fontWeight="bold">WorkSpace Recepção</Text>
        ...
        <Button height={8} colorScheme="whatsapp" onClick={() => navigate("/Recepcao/Consultas")}>Ir até consultas</Button>
        <Button height={8} colorScheme="whatsapp"  onClick={() => navigate("/Recepcao/Create")} >Ir até cadastro de cliente</Button>
        </Flex>
        
        </Flex>
        </WorkSpaceHeader>
          <WorkSpaceContent>
            <Flex direction="column" w="100%"  align="center" bgColor="gray.100" rounded={4} p="4" className="div1" justify="center" >
              ...
              <HStack mt="4"  w="100%" justify="space-evenly" pt="4">
                ...
                <Button onClick={() => navigate(`/Recepcao/Customer/Edit/${customer.id}`)} colorScheme="whatsapp">Editar</Button>     <Button colorScheme="whatsapp">Historico</Button>
            ...
            <Flex direction="column" bgColor="gray.100" rounded={4} p="2" className="div2" align="center" textAlign="center" >
              ...
              <Flex overflow="auto" overflowX="auto" w="100%" height="100%">
                ...
                <Table flexDirection="column" >
                  ...
                  <Thead >
                    {
                      customer.pets.length < 1 ? ( <Text fontWeight="black" mt="20" fontSize="2xl">SEM PET CADASTRADO</Text> ) : (<Tr>
            ...
            <Flex direction="column" bgColor="gray.100" rounded={4} p="2" className="div3" align="center" textAlign="center" >
              ...
              <Textarea value={moreInfos} onChange={(ev) => setMoreInfos(ev.target.value)} m="2" borderColor="gray.900" bgColor="white" height="80%"></Textarea>
            </Flex>

            <Flex direction="column" bgColor="gray.100" rounded={4} p="2" className="div4" align="center" textAlign="center" >

              <Flex gap={8} justify="space-evenly" w="100%" overflow="auto" height="100%">
