import { Button, ChakraProvider, Checkbox, Flex, Table, TableContainer, Tbody, Td, Text, Th, Thead, Tr } from "@chakra-ui/react";
        ...
        <Flex direction="column" height="100%" width="60%" bgColor="gray.100">
            ...
            <Flex height="60%" width="100" direction="column">
                 <Flex width="100%" height="48px" bgColor="gray.300" p="2" align="center" justify="center">
                    <Button colorScheme="whatsapp" onClick={setVaccineInPet}>INCLUIR VACINA</Button>
                        ...
                        <Tbody>
                            {
                                vaccines.map((vaccine) => (
                                    <Tr key={vaccine.id}>
                                    <Td><Checkbox onChange={(ev) => ev.target.checked === true ? setVaccineId(vaccine.id) : setVaccineId(0)}  value={vaccine.id} size="lg" borderColor="black"  />  </Td>
                                    <Td>{vaccine.name}</Td>
