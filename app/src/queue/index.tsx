    ...
    case path.pathname === "/Recepcao/Change":
      ...
      ( <ChakraProvider>
        ...
        <Flex m="2" justify="center" direction="column" textAlign="center" w="100vw">
          ...
          <Text fontWeight="bold" fontSize="2xl">Em Fila</Text>
          <Link to="/Home">
                ...
                <Tbody>
                  ...
                  <RadioGroup onChange={setQueryType} value={queryType}>
                    <Flex direction="column" >
                      ...
                      <Button colorScheme="teal" onClick={() => setPetInQueue(pet.id) }>ATUALIZAR FILA</Button>
                    </GenericModal>
                          <Button onClick={() => openModal()} colorScheme="whatsapp">{pet.name}</Button></Td>
                        <Td>{pet.race}</Td>
        ...
        <Flex m="2" justify="center" direction="column" textAlign="center" w="100vw">
          ...
          <Flex gap="2" >
              ...
              <Table colorScheme="whatsapp">
                ...
                <Tbody>
                  {
                    petsInQueue != null ? petsInQueue.map((pet: PetsInQueue) => (
                        <Tr key={pet.id}>
                        <Td color="black">{pet.queryType}</Td>  
                        <Td>{pet.customerName}</Td>
                        <Td>{pet.name}</Td>
